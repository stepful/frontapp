...
# Walk every page, stopping whenever you like
client.conversations.each do |page|
  page.items.each { |conversation| process(conversation) }
end

# Load every item across all pages into one Array
